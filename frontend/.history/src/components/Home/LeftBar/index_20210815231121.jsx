          ...
          <ul className="listMusics h-3/5 py-2 overflow-hidden rounded-xl bg-transparent">
            {
              listMusicInfo.map((value, pos) => (
                <li className="relative flex items-center" >
                  ...
                  <FontAwesomeIcon onClick={deleteMusic} id={getId(value.url)} icon={faBan} size="1x" className="absolute text-red-400 right-1 opacity-0  hover:opacity-100 cursor-pointer" />
