    ...
    <div className="flex flex-col mr-2 left-bar w-1/3 ">
      ...
      <div className="h-1/4 w-full bg-gray-800 flex flex-col my-1 rounded-xl">
        ...
        <div className="function-button grid grid-cols-auto">
          ...
          <button>
            {status ? (
              <FontAwesomeIcon className="text-white" icon={faPause} onClick={() => setStatus(true)} size="2x" />
            ) : (
              <FontAwesomeIcon className="text-white" icon={faPlay} onClick={() => setStatus(false)} size="2x" />
            )}
          </button>
          <button>
