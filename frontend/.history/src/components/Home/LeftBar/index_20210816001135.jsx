      ...
      <div className="h-1/4 w-full bg-gray-800 flex flex-col my-1 rounded-xl">
        ...
        <div className="px-2">
          ...
          <div class="text-gray-500 dark:text-gray-400 flex justify-between text-sm font-medium tabular-nums">
            <div>00:00</div>
            <div>{`${Math.floor(timeEnd / 60) < 10 ? '0' + Math.floor(timeEnd / 60) : Math.floor(timeEnd / 60)}:${timeEnd - 60 * Math.floor(timeEnd / 60) > 10 ? timeEnd - 60 * Math.floor(timeEnd / 60) : '0' + timeEnd - 60 * Math.floor(timeEnd / 60)}`console.log(timeEnd)}</div>
          </div>
        </div>
