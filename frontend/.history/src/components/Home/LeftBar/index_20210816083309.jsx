  ...
  return (
    <div className="flex flex-col mr-2 left-bar w-1/3 ">
      ...
      <div className="h-3/4 w-full flex ">
        ...
        <div className="w-2/5 h-full bg-red-900 rounded-xl p-2 flex flex-col"
          id="left-bar-friend0">
            <div className="search-user flex items-center  bg-white rounded-full mb-4">
              <input type="text" className="h-8 px-4 outline-none bg-transparent text-2xl w-10/12" placeholder="Tim kiem nguoi dung"  />
              <FontAwesomeIcon icon={faSearch} className="mr -4 text-xl bg-transparent" />
            </div>
          <div className="friend max-h-1/3">
            <div className="friend h-1/6 text-center">Ban be</div>
            <ul className=" friend w-full max-h-5/6 bg-red-900 rounded-xl overflow-hidden overflow-y-scroll" >
          ...
          <div className="group max-h-1/3">
            <div className="friend h-1/6 text-center">Nhom</div>
            <ul className=" friend w-full max-h-5/6 bg-red-900 rounded-xl overflow-hidden overflow-y-scroll" >
              <li className="friend flex w-full my-3">
                <img src="https://picsum.photos/50" className="rounded-full" alt="" />
                <div className="self-center mx-2 w-full">
