      ...
      <div className="h-3/4 w-full flex ">
        ...
        <div className="w-2/5 h-full bg-white rounded-xl p-2 flex flex-col"
          ...
          <div className="friend max-h-1/3">
            ...
            <ul className=" friend w-full max-h-5/6 bg-red-900 rounded-xl overflow-hidden overflow-y-scroll mb-4 px-4" >
          ...
          <div className="group max-h-1/3">
            ...
            <ul className=" friend w-full max-h-5/6 bg-red-900 rounded-xl overflow-hidden overflow-y-scroll px-4" >
              <li className="friend flex w-full my-3">
                <img src="https://picsum.photos/50" className="rounded-full" alt="" />
                <div className="self-center mx-2 w-full">
                  <p className="truncate w-9/12 font-medium">Be man</p>
