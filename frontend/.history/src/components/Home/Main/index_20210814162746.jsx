    ...
    <div className="w-3/5 mr-2 flex flex-wrap">
      <div className="chat-area h-5/6 w-full  pb-2">
        <div className="w-full h-full bg-white rounded-xl shadow-2xl text-chat flex justify-between">
          <div className="p-2">
            <div className="img">
              <img src="https://picsum.photos/60" className="w-12 h-12 rounded-full relative" alt="" />
              <div className="status-shape w-2 h-2 rounded-full bg-red-900 absolute bottom-0"></div>
            </div>
            <div className="info">
              <div className="name">Tran cao phuoc Long</div>
              <div className="status-text">Vua moi truy cap</div>
            </div>
