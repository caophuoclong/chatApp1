...
function Main(props) {
  return (
    <div className="w-3/5 mr-2 flex flex-wrap">
      <div className="chat-area h-5/6 w-full bg-gray-900 pb-2">
        <div className="w-full h-full rounded-xl shadow-2xl text-chat flex justify-between">
          <div className="p-2 flex bg-white">
            <div className="img relative w-15 h-12">
