...
function Main(props) {
  ...
  return (
    <div className="w-3/5 mr-2 flex flex-wrap">
      <div className="chat-area h-5/6 w-full pb-2 mb-2">
        ...
        <ul className="chat-show bg-bg_chat w-full rounded-bl-2xl rounded-br-2xl">

        </ul>
      </div>
      <form className="inp-area w-full  bg-black rounded-xl h-1/6 flex flex-cols items-center px-2 mb-2">
        <input
          type="text"
