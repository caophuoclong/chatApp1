  ...
  return (
    <div className="w-2/3 mr-2 flex flex-wrap">
      <div className="chat-area h-5/6 w-full pb-2">
        ...
        <ul className="chat-show bg-bg_chat w-full rounded-bl-2xl rounded-br-2xl shadow-inner px-2">
          <li className="message message-receiver">
            chao ban
          </li>
          <li className="message message-receiver">
            ban ten gi
          </li><li className="message message-sender">
            Minh ten long
          </li>
        </ul>
      </div>
