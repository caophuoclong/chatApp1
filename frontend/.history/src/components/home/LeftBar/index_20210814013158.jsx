        ...
        <div className="flex flex-col mx-2 left-bar w-1/3 border border-yellow-900">
            <div className="h-3/4 w-full flex">
                <div className="w-2/3 h-full bg-yellow-900 p-1">
                    ...
                    <div className="list-and-sear w-full h-auto bg-yellow-300 my-3 ">
                        <form action="" className="p-1 flex flex-nowrap">
                            <input type="text" className="h-9 rounded-full w-full" />
                            <button>
                                <FontAwesomeIcon icon={faSearch} size="1x" className="text-xl mx-2"/>
                            </button>
                        </form>
                    </div>
                </div>
