...
import { faPause, faPlay, faSearch, faStepBackward, faStepForward } from "@fortawesome/free-solid-svg-icons";
import "./leftbar.css";
    ...
    <div className="flex flex-col mx-2 left-bar w-1/3 border border-yellow-900">
      ...
      <div className="h-1/4 w-full bg-red-300 flex flex-col">
        ...
        <div className="function-button">
            ...
            <button>
            {1?<FontAwesomeIcon icon={faPause} size="2x"/>:<FontAwesomeIcon icon={faPlay} size="2x"/>}
            </button>
            <button>
