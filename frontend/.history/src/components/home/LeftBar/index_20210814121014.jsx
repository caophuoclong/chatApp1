    ...
    <div className="flex flex-col mx-2 left-bar w-1/3 border border-yellow-900">
      <div className="h-3/4 w-full flex">
        <div className="w-2/3 h-full bg-yellow-900 p-1">
          ...
          <ul className="listMusics h-3/4 py-2 overflow-hidden rounded-xl">
      ...
      <div className="h-1/4 w-full bg-gray-800 flex flex-col py-1 rounded-xl">
        <div className="p-3 flex flex-nowrap">
          <img
            ...
            alt=""
          />
          <p className="text-white-600 self-center mx-2 text-xl">Xin chao phuoc long</p>
        </div>
        <div className="px-2">
