  ...
  return (
    <div className="flex flex-col mx-2 left-bar w-1/3 ">
      <div className="h-3/4 w-full flex">
        <div className="w-2/3 h-full bg-yellow-900 p-1" id="left-panel">
          <div className="flex items-center user w-11/12 bg-red-900 h-12 border border-color-green-900 ring-2 ring-offset-red-600 rounded-2xl p-1 mr-5">
            <img
          ...
          <div className="list-and-sear  h-auto bg-yellow-300 my-3 rounded-full w-11/12">
          ...
          <ul className="listMusics h-3/5 py-2 overflow-hidden rounded-xl w-11/12">
