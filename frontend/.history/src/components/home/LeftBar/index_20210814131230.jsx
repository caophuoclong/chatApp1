  ...
  return (
    <div className="flex flex-col mx-2 left-bar w-1/3 ">
      <div className="h-3/4 w-full flex">
        <div className="w-3/5 h-full bg-yellow-900 p-1 relative" id="left-bar-music">
            <button id="resize-leftBar">
                {1?<FontAwesomeIcon icon={faChevronLeft} size="2x"/>:<FontAwesomeIcon icon={faChevronRight} size="2x"/>}
            </button>
        ...
        <div className="w-2/5 h-full bg-red-900" id="left-bar-friend">
