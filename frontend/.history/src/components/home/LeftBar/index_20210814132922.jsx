  ...
  return (
    <div className="flex flex-col mx-2 left-bar w-1/3 ">
      <div className="h-3/4 w-full flex ">
        ...
        <ul className="w-2/5 h-full bg-red-900 rounded-xl p-5" id="left-bar-friend">
            <li className="friend flex">
                <img src="https://picsum.photos/50" className="rounded-full" alt="" />
                <div className="self-center mx-2">
                    <h1 className="truncate">Be man</h1>
                    <h4 className="truncate">Xin chao anh yeu</h4>
                </div>
            </li>
        </ul>
      </div>
