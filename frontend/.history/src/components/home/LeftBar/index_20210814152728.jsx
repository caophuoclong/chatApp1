  ...
  return (
    <div className="flex flex-col mr-2 left-bar w-1/3 ">
      <div className="h-3/4 w-full flex ">
        <div className="w-3/5 h-full bg-transparent p-1 relative rounded-xl mr-2 border border-black shadow-2xl" id="left-bar-music">
        ...
        id="left-bar-friend0">
        <ul className="w-full h-full bg-red-900 rounded-xl p-2" id="left-bar-friend">
