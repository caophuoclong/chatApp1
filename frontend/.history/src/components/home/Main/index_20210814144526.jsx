    ...
    return (
        <div className="w-3/5 mr-2 flex flex-wrap">
            ...
            <form  className="inp-area w-full  bg-yellow-300 rounded-xl h-1/4 flex flex-cols items-center px-2">
                <input type="text" className="h-1/3 w-11/12 mr-2 outline-none px-3 text-xl font-bold color-inherit border rounded-full border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent ..." />
                <button>
