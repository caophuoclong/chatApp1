...
function Main(props) {
    return (
        <div className="w-3/5 mr-2 flex flex-wrap">
            ...
            <div className="chat-area h-5/6 w-full bg-black rounded-xl">

            </div>
            <form  className="inp-area w-full  bg-gray-200 rounded-xl h-1/6 flex flex-cols items-center px-2 my-2">
