...
function Index(props) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmitForm)}   className="w-1/2 flex flex-col justify-center items-center fixed top-1/2 lef-1/2 transform translate-x-1/2 translate-y-1/2" >
