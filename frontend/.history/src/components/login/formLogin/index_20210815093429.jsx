...
function Index(props) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmitForm)}   className="w-1/2 flex flex-col justify-center items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" >
            ...
            <div className="w-3/4 flex justify-between ring-2 ring-purple-600">
                <input type="text" autocomplete="off" className="w-full outline-none pl-4" id="username" {...register("username")}/>
