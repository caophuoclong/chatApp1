...
function Index(props) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmitForm)}   className="w-1/3 flex flex-col justify-center items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-screen form-login w-full" >
