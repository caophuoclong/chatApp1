...
function RegisterForm(props) {
    ...
    return (
        <form className="form flex flex-col items-center" onSubmit={handleSubmit(onSubmit)}>
            <h1>Dang ky</h1>
            <div className="">
                <input type="text" autocomplete="off" className="text-transparent" placeholder="Username" {...register("username")}/>
