...
function RegisterForm(props) {
    ...
    return (
        <form className="form flex flex-col items-center w-1/2" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="w-2/3 border border-gray-800 flex justify-between">
                <input type="text" autocomplete="off" className="w-3/4 outline-none px-4 text-2xl text-bold" placeholder="Username" {...register("username")}/>
