...
function RegisterForm(props) {
    ...
    return (
        <form className="form flex flex-col items-center w-1/2 p-9 bg-white rounded-3xl" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Link to="/login"><h2 className="text-2xl font-bold text-blue-900">Ban da co tai khoan?</h2></Link>
            <button className="w-3/4 h-9 bg-blue-300 my-4 rounded-full text-white text-2xl font-bold">Dang ky</button>
        </form>
    );
}
