...
const schema = yup.object().shape(
    {
        username: yup.string().required("Ban chua nhap tai khoan").matches(/^(?=[a-zA-Z0-9._]{8,20}$)(?!.*[_.]{2})[^_.].*[^_.]$/,"Tai khoan phai co nhieu hon 8 ky tu va khong bao gom ky tu dac biet"),
