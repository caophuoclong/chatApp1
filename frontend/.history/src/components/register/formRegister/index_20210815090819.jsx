...
const schema = yup.object().shape(
    {
        username: yup.string().required("Ban chua nhap tai khoan").matches(/^(?![0-9])[a-z0-9]{4,15}$/,"Tai khoan phai co nhieu hon 8 ky tu va khong bao gom ky tu dac biet"),
        password: yup.string().required("Vui long nhap mat khau").matches(/^[0-9a-zA-Z\@\!\?\_\$\^\&]{8,}$/,"Mat khau phai nhieu hon 8 ky tu"),
